...
public class BasePlayer {
	...
	private int skillPoints;                    //Current amount of skill points a character, in this case the player, currently has.
	private BaseCharacterClass playerClass;     //Character's class for the player
